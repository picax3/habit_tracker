...
def main():
    habits: list[Habit] = [
        ...
        track_habit('Personal Impurity', datetime(2025, 2,11, 6), cost=0, minutes_used=40, difficulty=3),
        track_habit('Self-control struggle', datetime(2025, 2, 16, 6), cost=40, minutes_used=720, difficulty=5),
